local assets =
{
   Asset("ANIM", "anim/crystal_shieldfx.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("crystal_shieldfx")
    inst.AnimState:SetBuild("crystal_shieldfx")
    ...
    inst._lightframe = net_tinybyte(inst.GUID, "crystal_shieldfx._lightframe", "lightdirty")
    inst._islighton = net_bool(inst.GUID, "crystal_shieldfx._islighton", "lightdirty")
    inst._lighttask = nil
...
return Prefab("crystal_shieldfx", fn, assets)
