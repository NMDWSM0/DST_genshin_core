...
function property_main:UpdateWeapon()
	...
	if skin_build ~= nil then
		if string.find(weaponbuild, "staff") ~= nil then
		    ...
		    self.playeranim:GetAnimState():OverrideItemSkinSymbol("swap_object", skin_build, swap_weaponbuild, weapon.GUID, "swap_staffs")
		elseif weaponbuild == "multitool_axe_pickaxe" then
		    self.playeranim:GetAnimState():OverrideItemSkinSymbol("swap_object", skin_build, "swap_object", weapon.GUID, swap_weaponbuild)
		else
		    self.playeranim:GetAnimState():OverrideItemSkinSymbol("swap_object", skin_build, swap_weaponbuild, weapon.GUID, swap_weaponbuild)
		end
    else
		if string.find(weaponbuild, "staff") ~= nil then
		    if weapon.prefab == "firestaff" then
