...
function Artifacts_ItemTile:Refresh()
    self.ispreviewing = false
    self.ignore_stacksize_anim = nil
...
function Artifacts_ItemTile:SetBaseScale(sc)
    self.basescale = sc
    self:SetScale(sc)
end

function Artifacts_ItemTile:OnControl(control, down)
    self:UpdateTooltip()
    return false
end

function Artifacts_ItemTile:UpdateTooltip()
...
function Artifacts_ItemTile:GetDescriptionString()
    local str = ""
...
function Artifacts_ItemTile:OnGainFocus()
    self:UpdateTooltip()
end
...
function Artifacts_ItemTile:SetOnQuantityChangedFn(fn)
    self.onquantitychangedfn = fn
end

function Artifacts_ItemTile:SetQuantity(quantity)
...
function Artifacts_ItemTile:SetPerishPercent(percent)
...
function Artifacts_ItemTile:SetPercent(percent)
...
function Artifacts_ItemTile:SetChargePercent(percent)
...
function Artifacts_ItemTile:SetChargeTime(t)
    self.rechargetime = t
...
function Artifacts_ItemTile:StartDrag()
    --self:SetScale(1,1,1)
...
function Artifacts_ItemTile:HasSpoilage()
