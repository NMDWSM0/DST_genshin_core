...
local talents_popup = Class(Widget, function(self, owner, up1parent, path)
    ...
    self.title = self:AddChild(Text("genshinfont", HasDoubleLine(self.description.titlename[1]) and 26 or 36, self.description.titlename[1], {211/255, 188/255, 142/255, 1}))
...
function talents_popup:ShowLevel(num)
    ...
    self.title:SetSize(HasDoubleLine(self.description.titlename[num]) and 26 or 36)
